...
%% Data generation
error_vx_plot = line(t(1,1:length(vref(1,:))),vref(1,:));
set(error_vx_plot, 'LineStyle', '-', 'Color', C7, 'LineWidth', 1.3*lw);
error_vy_plot = line(t(1,1:length(vref(2,:))),vref(2,:));
set(error_vy_plot, 'LineStyle', '-', 'Color', C14, 'LineWidth', 1.3*lw);
error_vz_plot = line(t(1,1:length(vref(3,:))),vref(3,:));
